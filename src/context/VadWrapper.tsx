...
export function VadWrapper({children}){
    ...
    const {ngrokServerUrl,setMsgLoading,oneWayUrl,socket2,usersArrRef,name,myAudioStream}:any = useData()
    ...
    const { jobId,candid, roomId, custEmailId, agentId, isHost, meetingIsLegit } = useAppSelector((state) => state.qpReducer);
